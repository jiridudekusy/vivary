...
COPY plugins/own-modules/rootfs/bind-modules.sh /usr/local/bin/bind-modules
COPY plugins/own-modules/rootfs/modules-watch.sh /usr/local/bin/modules-watch
